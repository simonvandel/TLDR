...
Simulations are an many ways very close to a dynamic model. Formally it is defined as \enquote{a system designed to imitate something real} \jenote{Find a better definition of a simulation}.
