...
Consider the following; When sending messages, what happens if the receiver isn’t ready to process them? To solve this problem, MPI dictates that an implementation must be able to store messages, however the way this is done is up to the implementation.
