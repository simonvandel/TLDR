...
The different sections will contain explanations, which will mostly consist of an informal explanation of the construct, as well as the syntax and the formal semantics. Some construct will merit more discussion and explaination than others.
