...
&\inference[$\text{INVOKE}_{B1\top}$]{\Braket{S,env_S} \Rightarrow_B \top}
                  {\Braket{x,env_S} \Rightarrow_B \top}
                  {,env_S(x) = \Braket{S,\epsilon}}
...
&\inference[$\text{INVOKE}_{B1\bot}$]{\Braket{S,env_S} \Rightarrow_B \bot}
                  {\Braket{x,env_S} \Rightarrow_B \bot}
                  {,env_S(x) = \Braket{S,\epsilon}}
...
&\inference[$\text{INVOKE}_{B2\top}$]{\Braket{S_1,env_s[x_1' \mapsto \Braket{S_2,x_2'}]} \Rightarrow_B \top}
                  {\Braket{x_1(x_2),env_s} \Rightarrow_B \top}
                 {,env_s(x_1) = \Braket{S_1,x_1'}, env_s(x_2) = \Braket{S_2,x_2'}}
\intertext{This rule is the same as $INVOKE_{B2\top}$, but instead of the boolean value being true, it is false.}
&\inference[$\text{INVOKE}_{B2\bot}$]{\Braket{S_1,env_S[x_1' \mapsto \Braket{S_2,x_2'}]} \Rightarrow_B \bot}
                  {\Braket{x_1(x_2),env_S} \Rightarrow_B \bot}
                 {,env_S(x_1) = \Braket{S_1,x_1'}, env_S(x_2) = \Braket{S_2,x_2'}}
\end{align*}
