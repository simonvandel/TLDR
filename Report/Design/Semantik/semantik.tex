...
%&\inference[TYPEOF]{}
                  %{e,st \vdash m \Rightarrow_A t}
									%{, \mathbb{T}(n) = t}
%\\\\
&\inference[$\text{PAR}_1$]{\Braket{S_1,e_1} \Rightarrow_S \Braket{S_1',e_1'}} 
                           {\Braket{\Braket{S_1,e_1}|\Braket{S_2,e_2},\alpha} \Rightarrow_S \Braket{\Braket{S_1,e_1'}|\Braket{S_2,e_2},\alpha}} 
\\\\ 
...
\\\\
&\inference[$\text{SEND}_2$]{e' = e(\alpha(\Ta))}
