...
%\\\\
&\inference[$\text{INIT}$]{e \vdash a \Rightarrow_B \bot}
                         {\Braket{x := a,e} \Rightarrow_S e'}
												{, e' = e[x \mapsto \bot]}
\\\\
&\inference[ASS]{}
                 {\Braket{x := S,e} \Rightarrow_S e'}
								 {, e' = e[x \mapsto \Braket{S,\epsilon}]}
\\\\
...
\\\\
&\inference[$\text{SEND}$]{}
                       {\Braket{\Tsend \Ta \Tm ; S,\alpha,e} \Rightarrow_S \Braket{\Ta.r(m),e,\alpha}|\Braket{S,e,\alpha}}
\end{align*}