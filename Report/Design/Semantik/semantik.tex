...
%\\\\
%&\inference[$\text{SEND}_1$]{\Braket{S,\alpha,e} \Rightarrow_S \Braket{S',\alpha',e'}}
                       %{\Braket{\Tsend \Ta \Tm ; S,\alpha,e} \Rightarrow_S \Braket{\Tsend \Ta \Tm;S',\alpha',e'}}
%\\\\
%&\inference[$\text{SEND}_2$]{\Braket{S,\alpha,e} \Rightarrow_S \Braket{\alpha',e'}}
                       %{\Braket{\Tsend \Ta \Tm;S,\alpha,e} \Rightarrow_S \Braket{\Tsend \Ta \Tm,\alpha',e'}}
\\\\
