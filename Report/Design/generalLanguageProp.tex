...
Dynamic typing checks types at run-time and one can argue this allows the programmer to not have the same mental overhead of thinking about types as static typing without type inference. This however comes at the price of safety and performance.
