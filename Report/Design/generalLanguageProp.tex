...
\end{center}
The \enquote{a} function holds which environment and user created structures that exists inside an instantiated actor. There is only one function for this since all actors can see all actors and there can only 
